...
function main() {
    ...
    if ($ret) {
        ...
        if ($val) {
            ...
            echo getJsonEncodedValue($val, "Client Validation Successfull");
        } else {
            header("Content-Type: application/json");
            echo getJsonEncodedValue(null, "Client Validation is Not Successfull");
        }
    } else {
        header("Content-Type: application/json");
        echo getJsonEncodedValue(null, "Error, Incorrect Validation For Client");  
    }
}
